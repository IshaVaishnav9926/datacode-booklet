    ...
    <div id="main" className='main-container h-auto w-100 px-5 pb-5 pt-0'>
      <div className=' container h-auto w-100 '>
        <div className='row '>
          <div className='col-md-8 p-0 '>
            <h1 className='text-start fw-bolder fw-bold ' style={{ fontSize: '74px' }} >Batman:
          ...
          <div className='col-md-4 d-block align-items-center text-start  text-lg-end '>
            <div className='h-auto ps-xl-3 ms-xl-3 text-start '>
              <h3 className='fw-bold ps-xl-5 ms-xl-5' style={{ fontSize: '29px' }}>Book Progress</h3>
              <h6 className='fw-bold ps-xl-5 ms-xl-5' style={{ fontSize: '19px' }} >Started:<span style={{ color: '#4A83F6' }}>5 days ago</span></h6>
            </div>
      ...
      <div className='h-50  my-3'>
        ...
        <div className='h-auto w-auto container  pb-4 '   >
          <div className='row'>
            <div className='col-md-5 col-sm-2 p-0 fs-2 fw-bolder'>Chapters:<span style={{ color: '#4A83F6' }}>20</span></div>
            <div className='col-md-5 col-sm-2 p-0 fs-2 fw-bolder '>Days:<span style={{ color: '#4A83F6' }}>20</span></div>
          </div>
        </div>
